...
${renderLdlResult('3', 'friedewald', 'Формула Фридвальда')}
    ...
    <details class="fc-calc__notes">
      ...
      <div class="fc-calc__notes-body">
        ...
        <p class="fc-calc__hint">Источник: <a href="https://noatero.ru/ru/doctors/calculators/#c3" target="_blank" rel="noopener noreferrer">НОА — Формулы расчёта ХС ЛПНП</a></p>
