...
- Отдельный `<link href="fonts.googleapis.com…">` — на FarmConsilium уже есть SF Pro
...
Шапка, меню, подвал — из Laravel. Виджет: SF Pro (с сайта), палитра HAS-BLED (`#10384f`, `#005eec`, `#eff0f2`) в `<style>` внутри `index.html`.
