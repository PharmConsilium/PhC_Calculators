...
export const BIOPSY_OPTIONS = [
  { id: 'u50_0', group: 'Возраст во время посещения консультации <50 лет:', label: 'Биопсии не выполнялись', coef: 1.0 },
  { id: 'u50_1', group: 'Возраст во время посещения консультации <50 лет:', label: '1 биопсия', coef: 1.7 },
  { id: 'u50_2', group: 'Возраст во время посещения консультации <50 лет:', label: '≥2 биопсии', coef: 2.88 },
  { id: 'ge50_0', group: 'Возраст во время посещения консультации ≥50 лет:', label: 'Биопсии не выполнялись', coef: 1.0 },
  { id: 'ge50_1', group: 'Возраст во время посещения консультации ≥50 лет:', label: '1 биопсия', coef: 1.27 },
  { id: 'ge50_2', group: 'Возраст во время посещения консультации ≥50 лет:', label: '≥2 биопсии', coef: 1.62 },
];
...
export const FIRST_BIRTH_RELATIVES_OPTIONS = [
  ...
  { id: '25_29_0', group: 'Возраст при рождении первого ребёнка 25–29 лет или не рожавшая женщина', label: 'Нет родственников 1-й степени с РМЖ', coef: 1.55 },
  { id: '25_29_1', group: 'Возраст при рождении первого ребёнка 25–29 лет или не рожавшая женщина', label: '1 родственник 1-й степени с РМЖ', coef: 2.76 },
  { id: '25_29_2', group: 'Возраст при рождении первого ребёнка 25–29 лет или не рожавшая женщина', label: '≥2 родственников 1-й степени с РМЖ', coef: 4.91 },
